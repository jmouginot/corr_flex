...
SUBROUTINE ampcor_flex(c_refimg,c_srchimg,nx_search,ny_search, &
    ...
    if (ny_s .NE. ny_m+2*ny_search) THEN
        print*,'ny_s:',ny_s
        print*,'ny_m:',ny_m
        print*,'ny_search:',ny_search
           ...
           !     now the search image
            ...
            DO i_yy=1,i_wsyjp
                do i_xx=1,i_wsxjp
                    ...
                    if(i_xx+r_shftx+nx_search-i_srchp .ge. 1 .and. &
                        i_xx+r_shftx+nx_search-i_srchp .le. nx_s .and. &
                        i_yy+r_shfty+ny_search-i_srchp .ge. 1 .and. &
                        i_yy+r_shfty+ny_search-i_srchp .le. ny_s) THEN
                        c_chipsch(i_index) = c_srchimg(NINT(i_xx+r_shftx+nx_search-i_srchp), &
                            NINT(i_yy+r_shfty+ny_search-i_srchp))
                    else
